  ...
  return (
    ...
    >
      ...
      <div className="flex w-full h-full bg-transparent overflow-hidden relative rounded-sm shadow-[0_0_20px_rgba(0,255,255,0.1)] border border-[#0ff]/20 z-10 flex-col">
        ...
        <div className="h-16 md:h-24 bg-[#02050a]/90 backdrop-blur border-b-2 border-[#0ff] shadow-[0_4px_20px_rgba(0,255,255,0.3)] z-30 flex items-center justify-between relative shrink-0">
           ...
           <div className="text-[#0ff] text-2xl md:text-5xl lg:text-6xl font-mono tracking-[0.3em] pl-4 md:pl-20 drop-shadow-[0_0_10px_rgba(0,255,255,1)] z-10 uppercase font-bold" style={{ textShadow: '2px 0 0 rgba(255,0,255,0.5), -2px 0 0 rgba(0,255,255,0.5)' }}>
             REQUIEM
           </div>

           {/* Central Cyber Clasp */}
           <div className="absolute top-[8px] md:top-[16px] left-1/2 -translate-x-1/2 w-16 h-16 md:w-28 md:h-28 bg-[#02050a] rounded-full shadow-[0_0_20px_rgba(0,255,255,0.4)] z-40 flex items-center justify-center border-2 md:border-4 border-[#0ff]/50 transition-transform hover:scale-105 cursor-pointer neon-ring-pulse">
               <div className="w-12 h-12 md:w-20 md:h-20 bg-[#02050a] rounded-full flex items-center justify-center shadow-[inset_0_0_20px_rgba(0,255,255,0.5)] border border-[#0ff]">
                   <div className="w-8 h-8 md:w-14 md:h-14 rounded-full border border-[#0ff]/50 flex items-center justify-center relative" style={{ background: 'radial-gradient(circle, rgba(0,255,255,0.1), transparent)' }}>
                      <div className="absolute inset-0 border-[2px] border-dashed border-[#b400ff]/40 rounded-full animate-[spin_10s_linear_infinite]" />
                      <span className="text-sm md:text-lg font-mono text-[#0ff] font-bold z-10 cyber-glitch tracking-widest mt-0.5" data-text="[SYS]" style={{ textShadow: '0 0 8px rgba(0,255,255,0.8)' }}>
                        [SYS]
                      </span>
                   </div>
               </div>
        ...
        <div className="hidden md:block absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#0ff] pointer-events-none" />
        <div className="hidden md:block absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#0ff] pointer-events-none" />
        <div className="hidden md:block absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#0ff] pointer-events-none" />
        <div className="hidden md:block absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#0ff] pointer-events-none" />
